...
CREATE UNIQUE INDEX index_username on sys_user(user_name);
...
-- 初始数据
INSERT INTO sys_user (user_id, user_name, password, salt, email, mobile, status, dept_id, create_time) VALUES ('1', 'admin', 'e1153123d7d180ceeb820d577ff119876678732a68eef4e6ffc0b1f06a01f91b', 'YzcmCZNvbXocrsz9dm8e', 'root@renren.io', '13612345678', '1', '1', CURRENT_DATE);
